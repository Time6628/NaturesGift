...
public class LegacyRecipes {
	...
	public static void register(FMLPreInitializationEvent preEvent) {
		...
		GameRegistry.addRecipe(new ItemStack(NGItems.MAGICAL_NATURE_STICK), "bdb", "gng", "bdb", 'd',
				new ItemStack(Items.DIAMOND), 'b', new ItemStack(Items.BONE), 'g', new ItemStack(NGItems.GRASS_CLIPPINGS), 'n',
